    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 12, 22, 7, 22, 7, 448, DateTimeKind.Utc).AddTicks(5976), "Software development courses", true, "Programming" },
                    { 2, new DateTime(2025, 12, 22, 7, 22, 7, 448, DateTimeKind.Utc).AddTicks(6512), "UI/UX and graphic design courses", true, "Design" },
                    { 3, new DateTime(2025, 12, 22, 7, 22, 7, 448, DateTimeKind.Utc).AddTicks(6514), "Business and management courses", true, "Business" },
                    { 4, new DateTime(2025, 12, 22, 7, 22, 7, 448, DateTimeKind.Utc).AddTicks(6515), "Digital marketing courses", true, "Marketing" }
                });
